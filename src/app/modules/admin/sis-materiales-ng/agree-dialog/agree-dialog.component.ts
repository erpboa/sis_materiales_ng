...
@Component({
    ...
    standalone: true,
    imports: [FormsModule, ReactiveFormsModule,MatFormFieldModule,MatInputModule,MatIconModule,MatDatepickerModule,TextFieldModule,MatRippleModule,MatButtonModule,MatNativeDateModule,MatLuxonDateModule],
...
export class AgreeDialogComponent {
    ...
    save(){
        ...
        this._toolService.agree(this._data.id,agree.serial_registrado,agree.nro_lote,agree.fecha_vencimiento).subscribe(
            (response)=>{
                this._matDialogRef.close();
            }
        );
