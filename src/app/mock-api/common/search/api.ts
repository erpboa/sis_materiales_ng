...
import { BobyNavigationItem, BobyNavigationService } from '@boby/components/navigation';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._bobyNavigationService.getFlatNavigation(this._defaultNavigation);
