...
import { BobyConfig, BobyConfigService } from '@boby/services/config';
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _bobyPlatformService: BobyPlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        // Set the OS name
        this._renderer2.addClass(this._document.body, this._bobyPlatformService.osName);
    }
