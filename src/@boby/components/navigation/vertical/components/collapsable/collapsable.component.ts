...
@Component({
    ...
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, BobyVerticalNavigationBasicItemComponent, forwardRef(() => BobyVerticalNavigationCollapsableItemComponent), BobyVerticalNavigationDividerItemComponent, BobyVerticalNavigationGroupItemComponent, BobyVerticalNavigationSpacerItemComponent],
})
