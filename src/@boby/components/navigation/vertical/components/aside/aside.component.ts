...
@Component({
    ...
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, BobyVerticalNavigationBasicItemComponent, BobyVerticalNavigationCollapsableItemComponent, BobyVerticalNavigationDividerItemComponent, BobyVerticalNavigationGroupItemComponent, BobyVerticalNavigationSpacerItemComponent],
})
