...
@Component({
    ...
    standalone     : true,
    imports        : [BobyScrollbarDirective, NgFor, NgIf, BobyVerticalNavigationAsideItemComponent, BobyVerticalNavigationBasicItemComponent, BobyVerticalNavigationCollapsableItemComponent, BobyVerticalNavigationDividerItemComponent, BobyVerticalNavigationGroupItemComponent, BobyVerticalNavigationSpacerItemComponent],
})
